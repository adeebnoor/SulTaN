...
try:
 with sync_playwright() as pw:
  ...
  for lang in ['ar','en']:
   ...
   with page.expect_download() as dl:page.locator('[data-action="project"]').first.click()
   ...
   with page.expect_download() as dl:page.locator('[data-action="report"]').first.click()
