...
const css=read('src/palette-unify.css'),home=read('src/home-value.css'),build=read('build.py');
...
assert.ok(build.includes('src/home-value.css')&&build.includes('src/palette-unify.css'),'both public palette layers are built');
assert.ok(build.indexOf('src/home-value.css')<build.indexOf('src/palette-unify.css'),'palette-unify loads after home-value');
