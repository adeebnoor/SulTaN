...
for name in ('locales/en.js','locales/ar.js','locales/authority-space.js','locales/execution-upgrades.js','locales/demo.js','i18n.js','engine.js','break-even-analytic.js','performance.js','import.js','portal.js','app.js','criteria-polarity.js','authority-space.js','execution-upgrades.js','assumption-register.js','review-visuals.js','usability.js'):
