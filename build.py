...
for name in ('locales/en.js','locales/ar.js','locales/authority-space.js','locales/execution-upgrades.js','i18n.js','engine.js','import.js','portal.js','app.js','authority-space.js','execution-upgrades.js','usability.js'):
