...
for name in ('version.js','locales/en.js','locales/ar.js','locales/authority-space.js','locales/execution-upgrades.js','locales/demo.js','final-locales.js','i18n.js','engine.js','break-even-analytic.js','performance.js','import.js','final-core.js','portal.js','app.js','criteria-polarity.js','authority-space.js','execution-upgrades.js','review-visuals.js','usability.js','final-ui.js','version-patch.js'):
