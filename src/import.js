...
const allowed={
 ...
 option:['id','title','type','outcome','whyUs','foothold','tradeoff','owner','decision','decisionReason','scores'],
 score:['value','note'],
