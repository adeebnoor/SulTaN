...
Object.assign(root.SultanLocales.en=root.SultanLocales.en||{}, {
  executionProgress:'Section exchange & progress',sectionExport:'Export this section',sectionImport:'Import / merge section',sectionNotStarted:'Not started',sectionOpenIssues:'%{0} open issue(s)',sectionComplete:'Complete and checked',
...
Object.assign(root.SultanLocales.ar=root.SultanLocales.ar||{}, {
  executionProgress:'تبادل القسم والتقدم',sectionExport:'تصدير هذا القسم',sectionImport:'استيراد / دمج قسم',sectionNotStarted:'لم يبدأ',sectionOpenIssues:'%{0} ملاحظة مفتوحة',sectionComplete:'مكتمل ومفحوص',
